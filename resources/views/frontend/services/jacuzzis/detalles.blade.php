        ...
        <header class="bg-own-secondary text-light py-4">
            <div class="container d-flex justify-content-between flex-wrap">
                ...
                <div class="d-flex x-flex-fill title-icons">
                    ...
                    <a href="https://www.instagram.com/?url=huitzilcalli.com/jacuzzi/{{ $cabin->slug }}" target="_blank" class="d-none btn btn-outline-light btn-icon rounded-circle d-flex align-items-center justify-content-center mx-1">
                                    ...
                                    @if($full_time_schedule != null)
                                        <div class="col-12 mb-3 align-items-center d-flex">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex w-100 flex-column ps-3 d-flex justify-content-center">
                                                    <h6 class="m-0 fw-bold">Todo el día (-{{ number_format($user->reservation_discount, 0) }}%)</h6>
                                                    <p class="m-0" style="color: #888">{{ date('H:i', strtotime($full_time_schedule['start'])) }} - {{ date('H:i', strtotime($full_time_schedule['end'])) }} hrs.</p>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @foreach ($schedules as $i => $schedule)
                                        <div class="col-12 mb-3 align-items-center d-flex">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex w-100 flex-column ps-3 d-flex justify-content-center">
                                                    <h6 class="m-0 fw-bold">{{ date('H:i', strtotime($schedule->start_time)) }} - {{ date('H:i', strtotime($schedule->end_time)) }} hrs.</h6>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                            ...
                            <div class="card">
                                <div class="card-body row">
                                    ...
                                    <div class="col-9 d-flex flex-column justify-content-evenly">
                                        ...
                                        <p class="fs-3 mb-0" >$ {{ number_format($cabin->precio1, 2) }} <span class="fs-6 text-uppercase" style="color: #888"></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body row">
                                    ...
                                    <div class="col-9 d-flex flex-column justify-content-evenly">
                                        ...
                                        <p class="fs-3 mb-0" >$ {{ number_format($cabin->precio2, 2) }} <span class="fs-6 text-uppercase" style="color: #888"></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body row bg-danger text-white">
                                    ...
                                    <div class="col-9 d-flex flex-column justify-content-evenly">
                                        ...
                                        <p class="fs-3 mb-0" >-{{ number_format($user->reservation_discount, 0) }}%</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('script')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                select: function(info) {
                    ...
                    $.ajax({
                        url: "{{ route('horarios.disponibilidad') }}",
                        method: 'POST',
                        headers: {
                        ...
                        success: (data) => {
                            ...
                            let url = encodeURI('https://wa.me/5214493102203?text='+('Hola, me gustaría reservar el jacuzzi {{ $cabin->name }} '+textDate));
        ...
        const makeRequest = () => {
            ...
            let url = encodeURI('https://wa.me/5214493102203?text='+('Hola, me gustaría reservar el jacuzzi {{ $cabin->name }} '+((selectedDates != null) ? ('del '+selectedDates.start.split(',')[0]+','+selectedDates.start.split(',')[1]+' al '+selectedDates.end.split(',')[0]+','+selectedDates.end.split(',')[1]) : '')));
        ...
        const shareWhatsapp = () => {
            if(
             ...
             || navigator.userAgent.match(/Windows Phone/i)
                ...
                window.open('whatsapp://send?text=https://huitzilcalli.com/jacuzzi/{{ $cabin->slug }}', '_blank');
            }else{
                window.open('https://web.whatsapp.com/send?text=https://huitzilcalli.com/jacuzzi/{{ $cabin->slug }}', '_blank');
            }
        }
        ...
        const shareFacebook = () => {
            if(window.orientation > 1){
                window.open('fb://page/huitzilcalli.com/jacuzzi/{{ $cabin->slug }}', '_blank');
            }else{
                window.open('https://www.facebook.com/sharer/sharer.php?u=huitzilcalli.com/jacuzzi/{{ $cabin->slug }}', '_blank');
            }
        }
