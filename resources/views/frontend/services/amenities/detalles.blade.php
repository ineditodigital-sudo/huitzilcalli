        ...
        <section class="gallery-section p-5 bg-own-secondary-light" style="padding-top: 6rem !important;">
            ...
            <div class="row">
                <div class="col-lg-7 d-flex">
                    <div class="w-100 overflow-hidden d-flex g1" style="border-radius: 0.75rem; overflow: hidden; height: max-content; aspect-ratio: 1/0.6; background-position: center; background-repeat: no-repeat; background-size: cover; background-image: url( '/public/{{ $auxGallery[0]['route'] }}' );">
                        <a class="flex-fill" style="display: flex; border: 0px solid white;" href="/public/{{ $auxGallery[0]['route'] }}" data-pswp-width="{{ $auxGallery[0]['width'] }}" data-pswp-height="{{ $auxGallery[0]['height'] }}">
                            
                        </a>    
                    <!-- <img src="{{ Vite::asset('resources/img/15-min.webp') }}" alt="Banner" class="w-100 img-fluid" style="object-fit: cover; height: auto;"> -->
                    </div>
                </div>
                <div class="col-lg-5 d-flex flex-column justify-content-between g2" style="gap: 1rem">
                    <div class="w-100 overflow-hidden d-flex " style="gap: 1rem; max-height: 66%; height: 66%;">
                        <div class="d-flex" style="width: 33%;">
                            <div class="d-flex flex-column flex-fill" style="gap: 1rem;">
                                <div class="w-100 overflow-hidden d-flex flex-fill" style="border-radius: 0.75rem; overflow: hidden; background-position: center; background-repeat: no-repeat; background-size: cover; background-image: url( '/public/{{ $auxGallery[1]['route'] }}' );">
                                    <a class="flex-fill" style="border-radius: 0.75rem; overflow: hidden; display: flex; border: 0px solid white;" href="/public/{{ $auxGallery[1]['route'] }}" data-pswp-width="{{ $auxGallery[1]['width'] }}" data-pswp-height="{{ $auxGallery[1]['height'] }}">
                                    </a>
                                </div>
                                <div class="w-100 overflow-hidden d-flex flex-fill" style="border-radius: 0.75rem; overflow: hidden; background-position: center; background-repeat: no-repeat; background-size: cover; background-image: url( '/public/{{ $auxGallery[2]['route'] }}' );">
                                    <a class="flex-fill" style="border-radius: 0.75rem; overflow: hidden; display: flex; border: 0px solid white;" href="/public/{{ $auxGallery[2]['route'] }}" data-pswp-width="{{$auxGallery[2]['width'] }}" data-pswp-height="{{ $auxGallery[2]['height'] }}">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex flex-fill">
                            <div class="w-100 overflow-hidden d-flex flex-fill" style="border-radius: 0.75rem; overflow: hidden; background-position: center; background-repeat: no-repeat; background-size: cover; background-image: url( '/public/{{ $auxGallery[3]['route'] }}' );">
                                <a class="flex-fill" style="border-radius: 0.75rem; overflow: hidden; display: flex; border: 0px solid white;" href="/public/{{ $auxGallery[3]['route'] }}" data-pswp-width="{{ $auxGallery[3]['width'] }}" data-pswp-height="{{ $auxGallery[3]['height'] }}">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="w-100 overflow-hidden d-flex flex-fill" style="gap: 1rem">
                        <div class="d-flex flex-fill">
                            <div class="w-100 overflow-hidden d-flex flex-fill" style="border-radius: 0.75rem; overflow: hidden; background-position: center; background-repeat: no-repeat; background-size: cover; background-image: url( '/public/{{ $auxGallery[4]['route'] }}' );">
                                <a class="flex-fill" style="border-radius: 0.75rem; overflow: hidden; display: flex; border: 0px solid white;" href="/public/{{ $auxGallery[4]['route'] }}" data-pswp-width="{{ $auxGallery[4]['width'] }}" data-pswp-height="{{ $auxGallery[4]['height'] }}">
                                </a>
                            </div>
                        </div>
                        <div class="d-flex position-relative" style="max-width: 33%; width: 33%;">
                            <div class="w-100 overflow-hidden d-flex flex-fill" style="border-radius: 0.75rem; overflow: hidden; background-position: center; background-repeat: no-repeat; background-size: cover; background-image: url( '/public/{{ $auxGallery[5]['route'] }}' );">
                                <a class="flex-fill" style="border-radius: 0.75rem; overflow: hidden; display: flex; border: 0px solid white;" href="/public/{{$auxGallery[5]['route'] }}" data-pswp-width="{{ $auxGallery[5]['width'] }}" data-pswp-height="{{ $auxGallery[5]['height'] }}">
                                </a>
                            </div>
                        </div>
                    </div>
                </div>
                @if(count($cabin->gallery) > 6)
                    <div class="d-none">
                        @foreach($cabin->gallery as $j => $p)
                            @if($j > 5)
                                <a class="flex-fill" style="border-radius: 0.75rem; overflow: hidden; display: flex; border: 0px solid white;" href="/public/{{ $p->route }}" data-pswp-width="{{ $p->width }}" data-pswp-height="{{ $p->height }}">
                                </a>
                            @endif
                        @endforeach
                    </div>
        ...
        <section class="g-section w-100 bg-own-secondary-light" style="padding-top: 6rem !important;">
            ...
            <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner">
                @foreach($cabin->gallery as $g => $gPhoto)
                <div class="carousel-item @if($g==0) active @endif">
                    <div class="w-100 overflow-hidden d-flex g1" style="border-radius: 0.0rem; overflow: hidden; height: max-content; aspect-ratio: 1/1; background-position: center; background-repeat: no-repeat; background-size: cover; background-image: url( '/public/{{ $gPhoto->route }}' );">
                        <a class="flex-fill" style="display: flex; border: 0px solid white;" href="/public/{{ $gPhoto->route }}" data-pswp-width="{{ $gPhoto->width }}" data-pswp-height="{{ $gPhoto->height }}">
                        </a>    
                    </div>
                </div>
                @endforeach
        ...
        <header class="bg-own-secondary text-light py-4">
            <div class="container d-flex justify-content-between flex-wrap">
                ...
                <div class="d-flex x-flex-fill title-icons">
                    ...
                    <a href="https://www.instagram.com/?url=huitzilcalli.com/caba%C3%B1a/{{ $cabin->slug }}" target="_blank" class="d-none btn btn-outline-light btn-icon rounded-circle d-flex align-items-center justify-content-center mx-1">
                    ...
                    <section class="mb-3">
                        <div class="card">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="https://www.google.com/maps/{{ '@'.$cabin->lat }},{{ $cabin->lng }},18z?hl=es-US&entry=ttu" target="_blank" class="d-flex btn btn-outline-secondary rounded-pill align-items-center ms-2 map-buttons">
                                    ...
                                    <div id="map-dropdown" class="dropdown border-0 d-none">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="https://www.google.com/maps/{{ '@'.$cabin->lat }},{{ $cabin->lng }},18z?hl=es-US&entry=ttu" target="_blank" style="cursor: pointer" class="dropdown-item">Abrir con Google Maps</a></li>
                                    ...
                                    <div class="col-12 mb-3 align-items-center d-flex">
                                        <div class="d-flex">
                                            ...
                                            <div class="d-flex w-100 flex-column ps-3 d-flex justify-content-center">
                                                ...
                                                <p class="m-0" style="color: #888">{{ $cabin->capacity }} Personas</p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="d-flex w-100 flex-column ps-3 d-flex justify-content-center">
                                                ...
                                                @if ($amenitie->specifications)
                                                    <p class="m-0" style="color: #888">{{ $amenitie->specifications }}</p>    
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body row">
                                    ...
                                    <div class="col-9 d-flex flex-column justify-content-evenly">
                                        ...
                                        <p class="fs-3 mb-0" >$ {{ number_format($cabin->precio1, 2) }} <span class="fs-6 text-uppercase" style="color: #888">/ noche</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body row">
                                    ...
                                    <div class="col-9 d-flex flex-column justify-content-evenly">
                                        ...
                                        <p class="fs-3 mb-0" >$ {{ number_format($cabin->precio2, 2) }} <span class="fs-6 text-uppercase" style="color: #888">/ noche</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body row">
                                    ...
                                    <div class="col-8 d-flex flex-column justify-content-evenly">
                                        ...
                                        <p class="fs-3 mb-0" >{{ substr($cabin->entrada, 0, 5) }} <span class="fs-6 text-uppercase" style="color: #888">hrs.</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body row">
                                    ...
                                    <div class="col-8 d-flex flex-column justify-content-evenly">
                                        ...
                                        <p class="fs-3 mb-0" >{{ substr($cabin->salida, 0, 5) }} <span class="fs-6 text-uppercase" style="color: #888">hrs.</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="tab-c-1" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                                        <p class="text-dark text-center"><span class="fs-5 fw-bold">1. </span>Selecciona los días que te gustaría reservar la cabaña. Haz clic y manten presionado para elegir varios días.</p>
                                    ...
                                    <div class="tab-pane fade" id="tab-c-2" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                                        <p class="text-dark text-center"><span class="fs-5 fw-bold">2. </span>Después, haz clic en el botón de "Reservar" para enviar una solicitud de reservación via WhatsApp en los días que que elegiste.</p>
                                        <div class="row d-flex justify-content-center">
                                            <div class="col-lg-8 col-sm-7 col-9">
                                                <img src="/resources/img/s2.webp" class="img-fluid w-100" />
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                        <section class="mb-3">
                            <div class="card">
                                ...
                                @endphp
                                <div class="form-text d-flex px-3" id="basic-addon4"><i class="uil uil-info-circle me-1"></i><p>Selecciona los días que te gustaría reservar la cabaña. Haz clic y manten presionado para elegir varios días.</p></div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body position-relative">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="tab-c-1" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                        <p class="text-dark text-center">Selecciona los días que te gustaría reservar la cabaña. Haz clic y manten presionado para elegir varios días.</p>
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-8 col-sm-7 col-10">
                                <img src="/resources/img/v2.gif" class="img-fluid w-100" />
                            </div>
                    ...
                    <div class="tab-pane fade" id="tab-c-2" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                        <p class="text-dark text-center">Después, haz clic en el botón de "Reservar" para enviar una solicitud de reservación via WhatsApp en los días que que elegiste.</p>
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-8 col-sm-7 col-9">
                                <img src="/resources/img/s2.webp" class="img-fluid w-100" />
                            </div>
...
@section('script')
    ...
    <script>
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                select: function(info) {
                    ...
                    if(dateObj.end == dateObj.start){
                        ...
                        textDate = 'del ' + dateObj.start.split(',')[0] + ', ' + dateObj.start.split(',')[1] + ' al ' + dateObj.end.split(',')[0] + ', ' + dateObj.end.split(',')[1];
                    }
                    
                    let url = encodeURI('https://wa.me/5214493102203?text='+('Hola, me gustaría reservar la amenidad {{ $cabin->name }} '+textDate));
                    
                    myp = new bootstrap.Popover('.fc-daygrid-bg-harness', {
                        trigger: 'manual', 
                        content: `
                            <div class="d-flex flex-column">
                                <p>Reservar cabaña ${textDate}</p>
                                <a target="_blank" href="${url}" class="btn btn-primary align-self-center" >Reservar</a>
                            </div>
                        `, 
                        placement: 'top', 
                        html: true
                ...
                initialEvents: [
                    @foreach($cabin->reservations as $r => $reservation)
                        @if(is_null($reservation->deleted_at))
                        {
                            start: '{{ substr($reservation->start,0,10) }}',
                            end: '{{ substr($reservation->end,0,10) }}',
                            display: 'background',
                            color: '#ff5b64'
                        },
                        @endif
                    @endforeach
                    @foreach($cabin->disableDays as $d => $day)
                        {
                            start: '{{ $day->date }}',
                            end: '{{ $day->date }}',
                            display: 'background',
        ...
        const makeRequest = () => {
            // let url = encodeURI('https://wa.me/524492850094?text='+('Hola, me gustaría reservar la cabaña {{ $cabin->name }} '+((selectedDates != null) ? ('del '+selectedDates.start.split(',')[0]+','+selectedDates.start.split(',')[1]+' al '+selectedDates.end.split(',')[0]+','+selectedDates.end.split(',')[1]) : '')));
            let url = encodeURI('https://wa.me/5214493102203?text='+('Hola, me gustaría reservar la amenidad {{ $cabin->name }} '+((selectedDates != null) ? ('del '+selectedDates.start.split(',')[0]+','+selectedDates.start.split(',')[1]+' al '+selectedDates.end.split(',')[0]+','+selectedDates.end.split(',')[1]) : '')));
        ...
        const shareWhatsapp = () => {
            if(
             ...
             || navigator.userAgent.match(/Windows Phone/i)
                ...
                window.open('whatsapp://send?text=https://huitzilcalli.com/caba%C3%B1a/{{ $cabin->slug }}', '_blank');
            }else{
                window.open('https://web.whatsapp.com/send?text=https://huitzilcalli.com/caba%C3%B1a/{{ $cabin->slug }}', '_blank');
            }
        }
        ...
        const shareWhatsapp2 = () => {
            if(
             ...
             || navigator.userAgent.match(/Windows Phone/i)
                ...
                window.open('whatsapp://send?text=https://www.google.com/maps/{{ '@'.$cabin->lat }},{{ $cabin->lng }},18z?hl=es-US&entry=ttu', '_blank');
            }else{
                window.open('https://web.whatsapp.com/send?text=https://www.google.com/maps/{{ '@'.$cabin->lat }},{{ $cabin->lng }},18z?hl=es-US&entry=ttu', '_blank');
            }
        }
        
        const shareFacebook = () => {
            if(window.orientation > 1){
                window.open('fb://page/huitzilcalli.com/caba%C3%B1a/{{ $cabin->slug }}', '_blank');
            }else{
                window.open('https://www.facebook.com/sharer/sharer.php?u=huitzilcalli.com/caba%C3%B1a/{{ $cabin->slug }}', '_blank');
            }
        }
        ...
        const toggleView = (el) => {
            if($('#calendar-section').hasClass('d-none')){
                ...
                calendar.updateSize();
                $(el).html(`
                    <i class="uil uil-estate fs-5 d-flex align-items-center justify-content-center me-2"></i>
                    Detalles
                `);
            }else{
