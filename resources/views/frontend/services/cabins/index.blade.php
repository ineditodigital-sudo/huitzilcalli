...
<div id="home-section" class="container-fluid">
            ...
            <div class="container overflow-hidden">
                <div class="row justify-content-center">
                    <div class="col-lg-8" data-aos="fade-up">
                        <img src="https://huitzilcalli.com/resources/img/logo-lg.webp" alt="Logo" class="img-fluid mb-4 logo-splash" style="max-height: 250px;">
                    </div>
                </div>
            </div>
        </header>
    ...
    <style>
        ...
        .logo-splash {
            animation: splash 1.5s cubic-bezier(0.175, 0.885, 0.32, 1.275) forwards;
        }
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 mb-4">
                        ...
                        <p class="small text-white-50">Ofrecemos una experiencia única de descanso y conexión con la naturaleza en Aguascalientes. Tu bienestar es nuestra prioridad.</p>
                    </div>
                    <div class="col-md-4 mb-4">
                        <h4 class="fw-bold text-uppercase mb-3 text-white" style="font-family: 'Oswald';">Navegación</h4>
                        <ul class="list-unstyled small">
                            <li><a href="#hero-section" class="text-white-50 text-decoration-none">Inicio</a></li>
                            <li><a href="#cabins-section" class="text-white-50 text-decoration-none">Nuestras Cabañas</a></li>
                            <li><a href="#promotions-section" class="text-white-50 text-decoration-none">Ofertas Especiales</a></li>
                        </ul>
                    </div>
                    <div class="col-md-4 mb-4">
                        <h4 class="fw-bold text-uppercase mb-3 text-white" style="font-family: 'Oswald';">Síguenos</h4>
                        <div class="d-flex">
