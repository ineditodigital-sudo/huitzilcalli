            ...
            <tbody id="table-body">
                ...
                <tr id="row-{{ $amenity->id }}">
                    ...
                    <td class="text-end d-flex justify-content-evenly">
                        <a class="btn btn-add btn-icon rounded-circle btn-xs d-flex aligm-items-center justify-content-center btn-cristal"  href="{{ route('detallesAmenidad', ['slug' => $amenity->slug]) }}" target="_blank" title="{{ __('Visualizar') }}">
        ...
        <div class="card position-relative">
            ...
            <div class="dropdown position-absolute top-0 end-0 border-0" style="z-index: 1000">
                ...
                <ul class="dropdown-menu dropdown-menu-dark">
                    <li><a href="{{ route('detallesAmenidad', ['slug' => $amenity->slug]) }}" style="cursor: pointer" class="dropdown-item">Visualizar</a></li>
