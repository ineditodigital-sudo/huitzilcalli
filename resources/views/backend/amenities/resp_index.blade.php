                ...
                <tr id="row-{{ $amenity->id }}">
                    ...
                    <td>
                        <div class="row gutters-5 w-300px w-md-300px mw-100">
                            ...
                            <div class="col">
                                <span class="text-muted text-truncate-2">{{ $amenity->name }}</span>
                            </div>
                        </div>
                    </td>
                    ...
                    <!--        <div class="col">-->
                    <!--            <span class="text-muted text-truncate-2">{{ $amenity->capacity }}</span>-->
                    <!--        </div>-->
                    <!--    </div>-->
                    <!--</td>-->
                    ...
                    <td style="max-width: 10rem; min-width: 10rem;">
                        <div class="row gutters-5 w-200px w-md-300px mw-100">
                            <div class="col">
                                <span class="text-muted text-truncate-2">$ {{ number_format($amenity->precio1, 2) }}</span>
                            </div>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="row gutters-5 w-200px w-md-300px mw-100">
                            <div class="col">
                                <span class="text-muted text-truncate-2">$ {{ number_format($amenity->precio2, 2) }}</span>
                            </div>
                        </div>
                    </td>
                    ...
                    <td>
                        <label class="aiz-switch aiz-switch-success mb-0">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" onchange="changeStatus({{ $amenity->id }}, this)" @if($amenity->active == 1) checked @endif role="switch" id="flexSwitchCheckDefault">
                            </div>
                        </label>
                    </td>
                    ...
                    <td class="text-end d-flex justify-content-evenly">
                        @if(false)
                        <a class="btn btn-add btn-icon rounded-circle btn-xs d-flex aligm-items-center justify-content-center btn-cristal"  href="{{ route('detallesJacuzzi', ['slug' => $amenity->slug]) }}" target="_blank" title="{{ __('Visualizar') }}">
                            <i class="uil uil-eye d-flex align-items-center justify-content-center fs-5"></i>
                        </a>
                        @endif
                        <a class="btn btn-calendar btn-icon rounded-circle btn-xs d-flex aligm-items-center justify-content-center btn-cristal"  href="{{ route('reservaciones.cabaña', ['service_type' => 'amenidades' ,'slug' => $amenity->slug]) }}" target="_blank" title="{{ __('Crear Reservación') }}">
                            <i class="uil uil-calendar-alt d-flex align-items-center justify-content-center fs-5"></i>
                        </a>
                        <button class="btn btn-edit btn-icon rounded-circle btn-xs d-flex align-items-center justify-content-center" onclick="editRow({{ $amenity->id }})" title="{{ __('Editar') }}">
                            <i class="uil uil-edit d-flex align-items-center justify-content-center fs-5"></i>
                        </button>
                        <button href="#" class="btn btn-delete btn-icon rounded-circle btn-xs d-flex confirm-delete align-items-center justify-content-center" onclick="deleteRow({{ $amenity->id }})" title="{{ __('Eliminar') }}">
...
<div class="row d-none" id="cards-section">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-3">
        <div class="card position-relative">
            <div class="d-flex" style="min-height: 15rem; max-height: 12rem; @if($amenity->active == 0) filter: grayscale(1); @endif">
                @if(count($amenity->gallery) > 0)
                <div id="carousel-{{ $amenity->id }}" class="carousel slide w-100 flex-fill" data-bs-ride="carousel">
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#carousel-{{ $amenity->id }}" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Anterior</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carousel-{{ $amenity->id }}" data-bs-slide="next">
            ...
            <div class="card-body" style="@if($amenity->active == 0) filter: grayscale(1); @endif">
                <h1 class="fs-5 fw-bold text-uppercase d-flex alig-items-center"><i class="uil uil-estate me-2 fw-5"></i>{{ $amenity->name }}</h1>
                <p class="mb-2 text-break" style="overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; line-clamp: 2; -webkit-box-orient: vertical;">{{ $amenity->description }}</p>
                <div class="d-flex flex-row flex-wrap align-items-center justify-content-evenly">
                    @foreach($amenity->amenities as $a => $amenitie)
                    ...
                    <div class="d-flex w-100 align-items-center justify-content-between">
                        <div class="btn btn-outline-secondary py-2 px-4 d-flex ps-2" style="border-radius: 0.5rem; cursor: default;">
                            ...
                            <div class="d-flex flex-column justify-content-evenly">
                                ...
                                <p class="mb-0">$ {{ number_format($amenity->precio1, 2) }}</p>
                            </div>
                        </div>
                        <div class="btn btn-outline-secondary py-2 px-4 d-flex ps-2" style="border-radius: 0.5rem; cursor: default;">
                            ...
                            <div class="d-flex flex-column justify-content-evenly">
                                ...
                                <p class="mb-0">$ {{ number_format($amenity->precio2, 2) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="dropdown position-absolute top-0 end-0 border-0" style="z-index: 1000">
                ...
                <ul class="dropdown-menu dropdown-menu-dark">
                    <li><a href="{{ route('detalles', ['slug' => $amenity->slug]) }}" style="cursor: pointer" class="dropdown-item">Visualizar</a></li>
                    <li><a href="{{ route('reservaciones.cabaña', ['service_type' => 'amenidades' ,'slug' => $amenity->slug]) }}" target="_blank" class="dropdown-item">Reservar</a></li>
                    <li><a style="cursor: pointer" class="dropdown-item" onclick="editRow({{ $amenity->id }})">Editar</a></li>
                    <li><a style="cursor: pointer" class="dropdown-item" onclick="deleteRow({{ $amenity->id }})">Eliminar</a></li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-7 mb-3">
                                    ...
                                    <div class="input-group has-validation">
                                        ...
                                        <input type="text" id="name" name="nombre" class="form-control" placeholder="{{ __('Nombre de la amenidad') }}" required>
                                ...
                                <div class="col-sm-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="1" id="capacity" name="capacidad" class="form-control" placeholder="{{ __('Cupo de la amenidad') }}" required>
                                ...
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <div class="input-group has-validation">
                                        <textarea type="text" id="description" maxlength="500" name="descripción" rows="4" class="form-control" style="resize: none;" placeholder="{{ __('Descripción de la amenidad') }}" required></textarea>
...
@section('script')
    ...
    <script>
        ...
        const loadData = () => {
            $.ajax({
                url: "{{ route('amenidades.show', ['id' => 0]) }}",
                method: 'GET',
                success: (res) => {
                    // if(res.table_view){
