                ...
                <div class="col-xl-4 col-lg-5 col-md-6">
                    <div class="d-flex justify-content-center">
                        <div class="d-flex justify-content-center align-items-center" style="width:20%; aspect-ratio: 1/1;">
                            <img class="img-fluid w-100" src="<?php echo e(__('https://temporal.huitzilcalli.com/resources/img/logo-lg.webp')); ?>" alt="Huitzilcalli">
                        </div>
                        <div class="d-flex flex-column justify-content-evenly ps-3">
                            <h2 class="fw-bolder text-start text-uppercase mb-0 index-main" style="font-family: 'Oswald";>Cabañas</h2>
                            <h1 class="text-uppercase text-start mb-0 fw-lighter index-secondary" style="font-family: 'Oswald";>Los Laureles</h1>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <section class="col-12 position-fixed top-50 start-50 translate-middle" id="cabins-section">
                <div class="row justify-content-evenly align-items-center">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <a href="<?php echo e(route('detalles', ['slug' => $cabin->slug])); ?>" class="btn text-decoration-none text-white w-100 d-flex flex-column p-0 border-0 overflow-hidden cabin-card my-2">
                            <?php if(count($cabin->gallery) > 0): ?>
                                <div class="img-container w-100 d-flex flex-fill" style="border-bottom-left-radius: 2rem; border-bottom-right-radius: 2rem">
                                    <div id="carousel-<?php echo e($cabin->id); ?>" class="carousel slide carousel-fade w-100 d-flex flex-fill" data-bs-ride="carousel">
                                        <div class="carousel-inner d-flex flex-fill" style="">
                                            ...
                                            <div class="carousel-item <?php if($g==0): ?> active <?php endif; ?>" style="border-bottom-left-radius: 2rem; border-bottom-right-radius: 2rem; object-fit: cover; background-image: url('https://temporal.huitzilcalli.com/public<?php echo e($photo->route); ?>'); background-size: cover; background-repeat:no-repeat; background-position: center;">
                                                <!--<img src="" class="d-block w-100 img-fluid" style="object-fit: cover; background-image: url('https://temporal.huitzilcalli.com/public<?php echo e($photo->route); ?>'); background-size: cover; background-repeat:no-repeat; background-position: center; min-height: 15rem; max-height: 12rem;" alt="">-->
                                            </div>
...
<?php echo $__env->make('frontend.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laurelescalvillo/public_html/temporal.huitzilcalli.com/resources/views/frontend/services/cabins/index.blade.php ENDPATH**/ ?>