...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if(isMobile()){
                ...
                calendar.setOption('eventSources', [
                    'https://localhost/LaurelesCalvillo/admin/res/jacuzzis/mobileJson/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>',
                    'https://localhost/LaurelesCalvillo/admin/dias/json/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>'
                ]);
            }else{
                // calendar.setOption('eventDisplay', 'list-item');
                calendar.setOption('displayEventTime', true);
                ...
                calendar.setOption('eventSources', [
                    'https://localhost/LaurelesCalvillo/admin/res/jacuzzis/json/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>',
                    'https://localhost/LaurelesCalvillo/admin/dias/json/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>'
                ]);
            }
        ...
        const editRow = (id) => {
            ...
            $.ajax({
                url: '/LaurelesCalvillo/admin/reserva/ver/'+id,
                method: 'GET',
                beforeSend: () => {
                    resetForm();
                },
        ...
        const deleteRow = (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/LaurelesCalvillo/admin/reserva/eliminar/"+id,
                        method: 'DELETE',
                        headers: {
                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                        },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LaurelesCalvillo\resources\views/backend/jacuzzi/reservations/index.blade.php ENDPATH**/ ?>