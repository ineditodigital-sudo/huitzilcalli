                    ...
                    <a class="dropdown-toggle text-dark no-arrow d-flex text-decoration-none" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="d-none d-md-block">
                                ...
                                <span class="d-block small opacity-60 text-decoration-none text-white fs-6" id="username-nav"><?php echo e((Auth::user()->user_type == 'admin') ? Auth::user()->name : 'Usuario'); ?></span>
                            </span>
                        </span>
                    </a>
...
</div><?php /**PATH C:\Users\Maindsteel\Documents\repos\Huitzilcalli\resources\views/backend/inc/nav.blade.php ENDPATH**/ ?>