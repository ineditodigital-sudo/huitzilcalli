                ...
                <div class="col-xl-4 col-lg-5 col-md-6">
                    <div class="d-flex justify-content-center">
                        <div class="d-flex justify-content-center align-items-center" style="width:20%; aspect-ratio: 1/1;">
                            <img class="img-fluid w-100" src="<?php echo e(__('https://localhost/LaurelesCalvillo/resources/img/logo-lg.webp')); ?>" alt="Huitzilcalli">
                        </div>
                                ...
                                <div class="img-container w-100 d-flex flex-fill" style="border-bottom-left-radius: 2rem; border-bottom-right-radius: 2rem">
                                    <div id="carousel-<?php echo e($cabin->id); ?>" class="carousel slide carousel-fade w-100 d-flex flex-fill" data-bs-ride="carousel">
                                        <div class="carousel-inner d-flex flex-fill" style="">
                                            ...
                                            <div class="carousel-item <?php if($g==0): ?> active <?php endif; ?>" style="border-bottom-left-radius: 2rem; border-bottom-right-radius: 2rem; object-fit: cover; background-image: url('https://localhost/LaurelesCalvillo/public<?php echo e($photo->route); ?>'); background-size: cover; background-repeat:no-repeat; background-position: center;">
...
<?php echo $__env->make('frontend.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LaurelesCalvillo\resources\views/frontend/services/jacuzzis/index.blade.php ENDPATH**/ ?>