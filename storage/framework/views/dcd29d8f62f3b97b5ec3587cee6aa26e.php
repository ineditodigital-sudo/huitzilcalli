<div class="aiz-sidebar-wrap">
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <a href="https://temporal.huitzilcalli.com/admin/caba%C3%B1as" class="d-block text-left text-decoration-none">
                <img class="mw-100 brand-icon" src="<?php echo e(__('https://temporal.huitzilcalli.com/resources/img/logo.png')); ?>" alt="Huitzilcalli">
                Los Laureles
            </a>
        </div>
...
<?php /**PATH /home/laurelescalvillo/public_html/temporal.huitzilcalli.com/resources/views/backend/inc/sidebar.blade.php ENDPATH**/ ?>