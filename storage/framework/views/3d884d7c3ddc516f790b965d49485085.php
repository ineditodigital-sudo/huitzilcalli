<?php
    $flag = str_contains(Request::url(),'caba%C3%B1a');
?>
...
<nav id="custom-nav" class="navbar custom-nav fixed-top navbar-expand-md <?php if($flag): ?> custom-secondary <?php endif; ?>">
    ...
    <div class="container-fluid px-5 py-2 d-flex">
        <a class="navbar-brand d-flex alig-items-center m-auto" href="<?php echo e(url('/')); ?>">
            <img src="<?php echo e(__('/LaurelesCalvillo/resources/img/logo-sm.webp')); ?>" data-src="<?php echo e(__('/LaurelesCalvillo/resources/img/logo-sm.webp')); ?>" alt="<?php echo e(config('app.name', 'APP_NAME')); ?>" class="lazyload d-inline-block align-text-top me-2" style="<?php if($flag): ?> opacity: 1 !important; <?php endif; ?>">
...
</script><?php /**PATH C:\xampp\htdocs\LaurelesCalvillo\resources\views/frontend/inc/nav.blade.php ENDPATH**/ ?>