        ...
        <header class="bg-own-secondary text-light py-4">
            <div class="container d-flex justify-content-between flex-wrap">
                ...
                <div class="d-flex x-flex-fill title-icons">
                    ...
                    <a href="https://www.instagram.com/?url=www.huitzilcalli.com/caba%C3%B1a/<?php echo e($cabin->slug); ?>" target="_blank" class="d-none btn btn-outline-light btn-icon rounded-circle d-flex align-items-center justify-content-center mx-1">
...
<?php $__env->startSection('script'); ?>
    ...
    <script type="module">
        import PhotoSwipeLightbox from "<?php echo e(__('https://localhost/LaurelesCalvillo/resources/js/photoswipe-lightbox.esm.js')); ?>";
        import PhotoSwipe from "<?php echo e(__('https://localhost/LaurelesCalvillo/resources/js/photoswipe.esm.js')); ?>";
    ...
    <script>
        ...
        const shareWhatsapp = () => {
            if(
             ...
             || navigator.userAgent.match(/Windows Phone/i)
                ...
                window.open('whatsapp://send?text=https://www.huitzilcalli.com/caba%C3%B1a/<?php echo e($cabin->slug); ?>', '_blank');
            }else{
                window.open('https://web.whatsapp.com/send?text=https://www.huitzilcalli.com/caba%C3%B1a/<?php echo e($cabin->slug); ?>', '_blank');
            }
        }
        ...
        const shareFacebook = () => {
            if(window.orientation > 1){
                window.open('fb://page/www.huitzilcalli.com/caba%C3%B1a/<?php echo e($cabin->slug); ?>', '_blank');
            }else{
                window.open('https://www.facebook.com/sharer/sharer.php?u=www.huitzilcalli.com/caba%C3%B1a/<?php echo e($cabin->slug); ?>', '_blank');
            }
        }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LaurelesCalvillo\resources\views/frontend/services/cabins/detalles.blade.php ENDPATH**/ ?>