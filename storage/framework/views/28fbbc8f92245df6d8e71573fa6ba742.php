...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                select: function(info) {
                    ...
                    let url = encodeURI('https://wa.me/5214493102203?text='+('Hola, me gustaría reservar la cabaña <?php echo e($cabin->name); ?> '+textDate));
        ...
        const makeRequest = () => {
            ...
            let url = encodeURI('https://wa.me/5214493102203?text='+('Hola, me gustaría reservar la cabaña <?php echo e($cabin->name); ?> '+((selectedDates != null) ? ('del '+selectedDates.start.split(',')[0]+','+selectedDates.start.split(',')[1]+' al '+selectedDates.end.split(',')[0]+','+selectedDates.end.split(',')[1]) : '')));
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/huitzilcalli/public_html/resources/views/frontend/services/cabins/detalles.blade.php ENDPATH**/ ?>