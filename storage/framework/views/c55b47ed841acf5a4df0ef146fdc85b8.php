...
<?php 
    //var_dump($amenities[4]->amenities[0]->title) 
?>

<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-auto">
            <h1 class="h4"><?php echo e(__('Amenidades')); ?></h1>
        </div>
        <div class="col text-end">
            <div class="btn-group">
                <a href="" onclick="newAmenity()" data-bs-toggle="modal" data-bs-target="#new-amenity" class="btn btn-circle btn-info">
                    <span><?php echo e(__('Nueva')); ?></span>
                </a>
            </div>
            <div class="btn-group">
...
<div class="card">
    <div class="card-body table-responsive" id="table-section">
        <table class="table aiz-table mb-0 align-middle">
            ...
            <tbody id="table-body">
                <?php $__currentLoopData = $amenities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $amenity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr id="row-<?php echo e($amenity->id); ?>">
                    ...
                    <td>
                        <div class="row gutters-5 w-300px w-md-300px mw-100">
                            ...
                            <div class="col">
                                <span class="text-muted text-truncate-2"><?php echo e($amenity->name); ?></span>
                            </div>
                        </div>
                    </td>
                    <td style="max-width: 10rem">
                        <div class="row gutters-5 w-300px w-md-300px mw-100">
                            <div class="col">
                                <span class="text-muted text-truncate-2" style="overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; line-clamp: 2; -webkit-box-orient: vertical;"><?php echo e($amenity->description); ?></span>
                            </div>
                        </div>
                    </td>
                    ...
                    <!--        <div class="col">-->
                    <!--            <span class="text-muted text-truncate-2"><?php echo e($amenity->capacity); ?></span>-->
                    <!--        </div>-->
                    <!--    </div>-->
                    <!--</td>-->
                    ...
                    <td style="max-width: 10rem; min-width: 10rem;">
                        <div class="row gutters-5 w-200px w-md-300px mw-100">
                            <div class="col">
                                <span class="text-muted text-truncate-2">$ <?php echo e(number_format($amenity->precio1, 2)); ?></span>
                            </div>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="row gutters-5 w-200px w-md-300px mw-100">
                            <div class="col">
                                <span class="text-muted text-truncate-2">$ <?php echo e(number_format($amenity->precio2, 2)); ?></span>
                            </div>
                        </div>
                    </td>
                    ...
                    <td>
                        <label class="aiz-switch aiz-switch-success mb-0">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" onchange="changeStatus(<?php echo e($amenity->id); ?>, this)" <?php if($amenity->active == 1): ?> checked <?php endif; ?> role="switch" id="flexSwitchCheckDefault">
                            </div>
                        </label>
                    </td>
                    ...
                    <td class="text-end d-flex justify-content-evenly">
                        <?php if(false): ?>
                        <a class="btn btn-add btn-icon rounded-circle btn-xs d-flex aligm-items-center justify-content-center btn-cristal"  href="<?php echo e(route('detallesJacuzzi', ['slug' => $amenity->slug])); ?>" target="_blank" title="<?php echo e(__('Visualizar')); ?>">
                            <i class="uil uil-eye d-flex align-items-center justify-content-center fs-5"></i>
                        </a>
                        <?php endif; ?>
                        <a class="btn btn-calendar btn-icon rounded-circle btn-xs d-flex aligm-items-center justify-content-center btn-cristal"  href="<?php echo e(route('reservaciones.jacuzzi', ['slug' => $amenity->slug])); ?>" target="_blank" title="<?php echo e(__('Crear Reservación')); ?>">
                            <i class="uil uil-calendar-alt d-flex align-items-center justify-content-center fs-5"></i>
                        </a>
                        <button class="btn btn-edit btn-icon rounded-circle btn-xs d-flex align-items-center justify-content-center" onclick="editRow(<?php echo e($amenity->id); ?>)" title="<?php echo e(__('Editar')); ?>">
                            <i class="uil uil-edit d-flex align-items-center justify-content-center fs-5"></i>
                        </button>
                        <button href="#" class="btn btn-delete btn-icon rounded-circle btn-xs d-flex confirm-delete align-items-center justify-content-center" onclick="deleteRow(<?php echo e($amenity->id); ?>)" title="<?php echo e(__('Eliminar')); ?>">
...
<div class="row d-none" id="cards-section">
    <?php $__currentLoopData = $amenities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c => $amenity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-3">
        <div class="card position-relative">
            <div class="d-flex" style="min-height: 15rem; max-height: 12rem; <?php if($amenity->active == 0): ?> filter: grayscale(1); <?php endif; ?>">
                <?php if(count($amenity->gallery) > 0): ?>
                <div id="carousel-<?php echo e($amenity->id); ?>" class="carousel slide w-100 flex-fill" data-bs-ride="carousel">
                    <div class="carousel-inner" style="min-height: 15rem; max-height: 12rem;">
                        <?php $__currentLoopData = $amenity->gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#carousel-<?php echo e($amenity->id); ?>" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Anterior</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carousel-<?php echo e($amenity->id); ?>" data-bs-slide="next">
            ...
            <div class="card-body" style="<?php if($amenity->active == 0): ?> filter: grayscale(1); <?php endif; ?>">
                <h1 class="fs-5 fw-bold text-uppercase d-flex alig-items-center"><i class="uil uil-estate me-2 fw-5"></i><?php echo e($amenity->name); ?></h1>
                <p class="mb-2 text-break" style="overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; line-clamp: 2; -webkit-box-orient: vertical;"><?php echo e($amenity->description); ?></p>
                <div class="d-flex flex-row flex-wrap align-items-center justify-content-evenly">
                    <?php $__currentLoopData = $amenity->amenities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a => $amenitie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="d-flex w-100 align-items-center justify-content-between">
                        <div class="btn btn-outline-secondary py-2 px-4 d-flex ps-2" style="border-radius: 0.5rem; cursor: default;">
                            ...
                            <div class="d-flex flex-column justify-content-evenly">
                                ...
                                <p class="mb-0">$ <?php echo e(number_format($amenity->precio1, 2)); ?></p>
                            </div>
                        </div>
                        <div class="btn btn-outline-secondary py-2 px-4 d-flex ps-2" style="border-radius: 0.5rem; cursor: default;">
                            ...
                            <div class="d-flex flex-column justify-content-evenly">
                                ...
                                <p class="mb-0">$ <?php echo e(number_format($amenity->precio2, 2)); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="dropdown position-absolute top-0 end-0 border-0" style="z-index: 1000">
                ...
                <ul class="dropdown-menu dropdown-menu-dark">
                    <li><a href="<?php echo e(route('detalles', ['slug' => $amenity->slug])); ?>" style="cursor: pointer" class="dropdown-item">Visualizar</a></li>
                    <li><a href="<?php echo e(route('reservaciones.jacuzzi', ['slug' => $amenity->slug])); ?>" target="_blank" class="dropdown-item">Reservar</a></li>
                    <li><a style="cursor: pointer" class="dropdown-item" onclick="editRow(<?php echo e($amenity->id); ?>)">Editar</a></li>
                    <li><a style="cursor: pointer" class="dropdown-item" onclick="deleteRow(<?php echo e($amenity->id); ?>)">Eliminar</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<!-- New Jacuzzi Modal -->
<div class="modal fade" id="new-amenity" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="new-amenity-title"></h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="formJacuzzi" novalidate method="post" autocomplete="off" class="needs-validation">
                <?php echo csrf_field(); ?>
                <input type="text" id="amenitie_id" name="amenitie_id" readonly hidden disabled>
                            ...
                            <div class="row">
                                <div class="col-sm-7 mb-3">
                                    ...
                                    <div class="input-group has-validation">
                                        ...
                                        <input type="text" id="name" name="nombre" class="form-control" placeholder="<?php echo e(__('Nombre de la amenidad')); ?>" required>
                                ...
                                <div class="col-sm-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="1" id="capacity" name="capacidad" class="form-control" placeholder="<?php echo e(__('Cupo de la amenidad')); ?>" required>
                                ...
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <div class="input-group has-validation">
                                        <textarea type="text" id="description" maxlength="500" name="descripción" rows="4" class="form-control" style="resize: none;" placeholder="<?php echo e(__('Descripción de la amenidad')); ?>" required></textarea>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        const newAmenity = () => {
            $('#new-amenity-title').text('Nueva Amenidad');
            resetForm();
            //initDropzone();
            initImageUploader();
            initMap();
        ...
        const loadData = () => {
            $.ajax({
                url: "<?php echo e(route('amenidades.show', ['id' => 0])); ?>",
                method: 'GET',
                success: (res) => {
                    // if(res.table_view){
        ...
        const editRow = (id) => {
            $('#new-amenity-title').text('Editar Amenidad');
            // console.log({id});
            $.ajax({
                url: '/admin/amenidades/ver/'+id,
                method: 'GET',
                beforeSend: () => {
                    resetForm();
                },
        ...
        const deleteRow = (id) => {
            Swal.fire({
                ...
                text: "¿Estás seguro que quieres eliminar esta amenidad?",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/admin/amenidades/eliminar/"+id,
                        method: 'DELETE',
                        headers: {
        ...
        const saveAmenidad = () => {
            ...
            console.log("auxAmenities:::", auxAmenities);
        ...
        const initDropzone = (gallery = []) => {
            ...
            let id = document.getElementById('amenitie_id').value;
            $('#drop').html('');
            try{
                myDropzone.destroy();
            }catch(e){
            ...
            myDropzone.on("successmultiple", function(files, response) {
                ...
                let auxId = document.getElementById('amenitie_id').value;
                if(auxId != ''){
        ...
        const submitData = () => {
            ...
            $.ajax({
                url: "<?php echo e(route('amenidades.store')); ?>",
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                },
        ...
        const changeStatus = (id,el) => {
            console.log({id, el});
            $.ajax({
                url: '<?php echo e(route("amenidades.status")); ?>',
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                },
        ...
        const initGrid = () => {
            $.ajax({
                url: '<?php echo e(route("amenidades.list")); ?>',
                method: 'GET',
                success: (res) => {
                    $("#grid").dxDataGrid({
                        dataSource: res.data,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Maindsteel\Documents\repos\Huitzilcalli\resources\views/backend/amenities/index.blade.php ENDPATH**/ ?>