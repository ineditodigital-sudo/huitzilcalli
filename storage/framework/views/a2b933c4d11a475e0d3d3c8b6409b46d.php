            ...
            <div class="d-flex" style="min-height: 15rem; max-height: 12rem; <?php if($jacuzzi->active == 0): ?> filter: grayscale(1); <?php endif; ?>">
                ...
                <div id="carousel-<?php echo e($jacuzzi->id); ?>" class="carousel slide w-100 flex-fill" data-bs-ride="carousel">
                    <div class="carousel-inner" style="min-height: 15rem; max-height: 12rem;">
                        ...
                        <div class="carousel-item <?php if($g==0): ?> active <?php endif; ?>" style="object-fit: cover; background-image: url('https://temporal.huitzilcalli.com/public<?php echo e($photo->route); ?>'); background-size: cover; background-repeat:no-repeat; background-position: center; min-height: 15rem; max-height: 12rem;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laurelescalvillo/public_html/temporal.huitzilcalli.com/resources/views/backend/jacuzzi/index.blade.php ENDPATH**/ ?>