                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-3 <?php if(!empty($cabin)): ?> d-none <?php endif; ?>">
                            ...
                            <div class="input-group has-validation">
                                <select type="text" id="cabin_id" name="cabin_id" class="form-select" placeholder="<?php echo e(__('Amenidad')); ?>" required>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        const submitData = () => {
            ...
            $.ajax({
                url: "<?php echo e(route('reservaciones.store', ['service_type' => 'amenidades'])); ?>",
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/huitzilcalli/public_html/resources/views/backend/amenities/reservations/index.blade.php ENDPATH**/ ?>