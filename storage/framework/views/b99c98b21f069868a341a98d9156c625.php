        ...
        <div class="col-lg-6 col-md-8 col-sm-12">
            ...
            <div class="card p-0 border-0 overflow-hidden">
                <div class="card-body p-0">
                    <div class="row m-0">
                        <div class="col-md-6 bg-secondary" style="background-image: url('https://huitzilcalli.com/build/assets/login-form.webp'); background-position: center; background-size: cover; background-repeat: no-repeat;"></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Maindsoft\Documents\Repos\LaurelesCalvillo\resources\views/auth/login.blade.php ENDPATH**/ ?>