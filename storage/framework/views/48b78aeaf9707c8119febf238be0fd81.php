...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-auto">
            <h1 class="h4"><?php echo e(__('Perfil')); ?></h1>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-12 d-flex align-items-center justify-content-center mb-3">
                        <img src="<?php echo e(__('https://temporal.huitzilcalli.com/resources/img/logo.png')); ?>" alt="Huitzilcalli" class="img-fluid rounded-circle p-2 bg-light" style="aspect-ratio: 1/1; max-width: 5rem;" />
                    </div>
        ...
        <div class="modal-content">
            ...
            <form id="formUser" novalidate method="post" autocomplete="off" class="needs-validation">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12 mb-3">
                            <label for="username" class="form-label"><?php echo e(__('Usuario')); ?></label>
                            <div class="input-group has-validation">
                                <input type="text" id="username" name="username" class="form-control" placeholder="<?php echo e(__('Usuario')); ?>" required value="<?php echo e(Auth::user()->username); ?>">
                        ...
                        <div class="col-sm-12 mb-3">
                            ...
                            <div class="input-group has-validation">
                                <input type="name" id="name" name="name" class="form-control" placeholder="<?php echo e(__('Nombre')); ?>" required value="<?php echo e(Auth::user()->name); ?>">
                        ...
                        <div class="col-sm-12 mb-3">
                            <label for="phone" class="form-label"><?php echo e(__('Número de WhatsApp')); ?></label>
                            <div class="input-group has-validation">
                                <input type="text" id="phone" name="phone" class="form-control" placeholder="<?php echo e(__('+52 1 449 000 0000')); ?>" required value="<?php echo e(Auth::user()->phone); ?>">
        ...
        <div class="modal-content">
            ...
            <form id="formPassword" novalidate method="post" autocomplete="off" class="needs-validation">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12 mb-3">
                            <label for="old_password" class="form-label"><?php echo e(__('Contraseña Actual')); ?></label>
                            <div class="input-group has-validation">
                                <input type="password" id="old_password" name="old_password" class="form-control" placeholder="<?php echo e(__('Contraseña Actual')); ?>" required>
                                <button type="button" onclick="togglePassword('old_password')" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="<?php echo e(__('Mostrar Contraseña')); ?>">
                        ...
                        <div class="col-sm-12 mb-3">
                            <label for="new_password" class="form-label"><?php echo e(__('Nueva Contraseña')); ?></label>
                            <div class="input-group has-validation">
                                <input type="password" id="new_password" name="new_password" class="form-control" placeholder="<?php echo e(__('Nueva Contraseña')); ?>" required>
                                <button type="button" onclick="togglePassword('new_password')" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="<?php echo e(__('Mostrar Contraseña')); ?>">
                                    <i class="uil uil-eye" id="btnTogglePassword"></i>
                                </button>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo e(__('Cancelar')); ?></button>
                <button type="button" id="submitPassword" onClick="submitPassword()" class="btn btn-primary"><?php echo e(__('Guardar')); ?></button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    const loadData = () => {
        $.ajax({
            url: "<?php echo e(route('admin.profile.show')); ?>",
            method: 'GET',
            success: (res) => {
                // console.log({res});
    ...
    const loadSettingsData = () => {
        $.ajax({
            url: "<?php echo e(route('admin.get.settings')); ?>",
            method: 'GET',
            success: (res) => {
                // console.log({res});
    ...
    const editUser = () => {
        // loadData();
        $.ajax({
            url: "<?php echo e(route('admin.profile.show', ['json'=>true])); ?>",
            method: 'GET',
            success: (res) => {
    ...
    const submitData = () => {
        $.ajax({
            url: "<?php echo e(route('admin.edit')); ?>",
            method: 'POST',
            headers: {
    ...
    const submitPassword = () => {
        $.ajax({
            url: "<?php echo e(route('admin.password')); ?>",
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            },
    ...
    const submitSettings = () => {
        $.ajax({
            url: "<?php echo e(route('admin.update.settings')); ?>",
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laurelescalvillo/public_html/temporal.huitzilcalli.com/resources/views/backend/user/index.blade.php ENDPATH**/ ?>