        ...
        <div class="col-lg-6 col-md-8 col-sm-12">
            ...
            <div class="card p-0 border-0 overflow-hidden">
                <div class="card-body p-0">
                    <div class="row m-0">
                        <div class="col-md-6 bg-secondary" style="background-image: url('https://temporal.huitzilcalli.com/build/assets/login-form.webp'); background-position: center; background-size: cover; background-repeat: no-repeat;"></div>
                        <div class="col-md-6 p-5 bg-cristal">
                            <form action="<?php echo e(route('login')); ?>" novalidate method="post" autocomplete="off" class="needs-validation">
                                ...
                                <div class="d-flex w-100 align-items-center justify-content-center img-logo">
                                    <img style=" aspect-ratio: 1/1; max-width: 40%; width: 40%;" class="img-fluid" src="https://temporal.huitzilcalli.com/resources/img/logo-lg.webp" alt="Banner">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12 text-center mt-3">
                                        <button type="submit" class="btn btn-primary"><?php echo e(__('Ingresar')); ?></button>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laurelescalvillo/public_html/temporal.huitzilcalli.com/resources/views/auth/login.blade.php ENDPATH**/ ?>