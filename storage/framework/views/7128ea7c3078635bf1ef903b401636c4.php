        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if(isMobile()){
                ...
                calendar.setOption('eventSources', [
                    'https://temporal.huitzilcalli.com/admin/rev/jacuzzis/mobilejson/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>',
                    'https://temporal.huitzilcalli.com/admin/dias/json/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>'
                ]);
            }else{
                // calendar.setOption('eventDisplay', 'list-item');
                ...
                calendar.setOption('eventSources', [
                    'https://temporal.huitzilcalli.com/admin/res/jacuzzis/json/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>',
                    'https://temporal.huitzilcalli.com/admin/dias/json/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>'
                ]);
            }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laurelescalvillo/public_html/temporal.huitzilcalli.com/resources/views/backend/jacuzzi/reservations/index.blade.php ENDPATH**/ ?>