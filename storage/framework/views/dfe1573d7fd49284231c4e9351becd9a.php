                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-3 <?php if(!empty($cabin)): ?> d-none <?php endif; ?>">
                            <label for="basic-url" class="form-label"><?php echo e(__('Amenidad')); ?></label>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                dateClick: function(info) {
                    ...
                    let list = '';
                    $.ajax({
                        url: "<?php echo e(route('reservaciones.dia2', ['service_type' => 'amenidades'])); ?>",
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                        },
            ...
            if(isMobile()){
                ...
                calendar.setOption('eventSources', [
                    'https://huitzilcalli.com/admin/rev/amenidades/mobilejson/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>',
                ...
                calendar.setOption('eventSources', [
                    'https://huitzilcalli.com/admin/res/amenidades/json/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>',
                    'https://huitzilcalli.com/admin/dias/json/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>'
                ]);
            }
        ...
        const checkAvailability = (initialValue = null) => {
            ...
            let date = $('#date').val();
            $.ajax({
                url: "<?php echo e(route('reservaciones.revisar.amenidad')); ?>",
                data: {
        ...
        const submitData = () => {
            ...
            $.ajax({
                url: "<?php echo e(route('reservaciones.amenidad.store', ['service_type' => 'amenidades'])); ?>",
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                },
        ...
        const loadFilteredData = (startDate) => {
            ...
            $.ajax({
                url: "<?php echo e(route('reservaciones.search')); ?>?start=" + startDate + "&service_type=amenidades", 
                method: 'GET',
                success: (res) => {
                    console.log("RES:::::", res);
                    $('#table-body').html(res.table_view);
        ...
        const loadDataByName = (name) => {
            ...
            $.ajax({
                url: "<?php echo e(route('reservaciones.searchByName')); ?>?name=" + name + "&service_type=amenidades",   
                method: 'GET',
                success: (res) => {
                    console.log("RES:::::", res);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Maindsteel\Documents\repos\Huitzilcalli\resources\views/backend/amenities/reservations/index.blade.php ENDPATH**/ ?>