...
<head>
    ...
    <link rel="apple-touch-icon" sizes="128x128" href="https://huitzilcalli.com/resources/img/apple-icon.webp">
    <link rel="icon" sizes="192x192" href="https://huitzilcalli.com/resources/img/apple-icon.webp">
    ...
    <script src="<?php echo e(__('/public/build/assets/app-d4b42df8.js')); ?>"></script>
    <!--<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script>-->
    
    <!-- CSS -->
    <link rel="stylesheet" href="<?php echo e(__('/public/build/assets/app-304379a8.css')); ?>?v=<?php echo e(rand()); ?>">
...
</html><?php /**PATH /home/huitzilcalli/public_html/resources/views/frontend/layouts/index.blade.php ENDPATH**/ ?>