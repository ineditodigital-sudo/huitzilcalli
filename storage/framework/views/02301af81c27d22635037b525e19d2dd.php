    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('cabañas.index')); ?>" class="aiz-side-nav-link">
                        <i class="uil uil-calendar-alt aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text"><?php echo e(__('Reservaciones')); ?></span>
                    </a>
                </li>
            </ul>
        </div>
...
<?php /**PATH /Users/carlosmartinez/Downloads/laureles-web (6)/resources/views/backend/inc/sidebar.blade.php ENDPATH**/ ?>