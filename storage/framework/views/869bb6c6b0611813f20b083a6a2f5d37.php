        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if(isMobile()){
                ...
                calendar.setOption('eventSources', [
                    'https://temporal.huitzilcalli.com/admin/rese/cabañas/mobileJson/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>',
                ...
                calendar.setOption('eventSources', [
                    'https://temporal.huitzilcalli.com/admin/res/cabañas/json/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>',
                    'https://temporal.huitzilcalli.com/admin/dias/json/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>'
                ]);
            }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laurelescalvillo/public_html/temporal.huitzilcalli.com/resources/views/backend/reservation/index.blade.php ENDPATH**/ ?>