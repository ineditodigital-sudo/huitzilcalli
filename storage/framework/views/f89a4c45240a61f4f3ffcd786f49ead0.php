            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-12 d-flex align-items-center justify-content-center mb-3">
                        <img src="<?php echo e(__('https://localhost/LaurelesCalvillo/resources/img/logo.png')); ?>" alt="Huitzilcalli" class="img-fluid rounded-circle p-2 bg-light" style="aspect-ratio: 1/1; max-width: 5rem;" />
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LaurelesCalvillo\resources\views/backend/user/index.blade.php ENDPATH**/ ?>