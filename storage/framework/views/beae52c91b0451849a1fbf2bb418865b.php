...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-auto">
            <h1 class="h4"><?php echo e(__('Horarios')); ?></h1>
        </div>
            ...
            <div class="card-body table-responsive" id="table-section">
                <table class="table aiz-table mb-0 align-middle">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th><?php echo e(__('Inicio')); ?></th>
                            <th><?php echo e(__('Fin')); ?></th>
            ...
            <form id="formSchedule" novalidate method="post" autocomplete="off" class="needs-validation">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="basic-url" class="form-label"><?php echo e(__('Inicio')); ?></label>
                                <div class="input-group has-validation">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="basic-url" class="form-label"><?php echo e(__('Fin')); ?></label>
                                <div class="input-group has-validation">
...
<script>
    ...
    const loadData = () => {
        $.ajax({
            url: "<?php echo e(route('jacuzzi.horarios.show', ['id' => 0])); ?>",
            method: 'GET',
            success: (res) => {
    ...
    const submitData = () => {
        ...
        $.ajax({
            url: "<?php echo e(route('jacuzzi.horarios.store')); ?>",
            method: 'POST',
            headers: {
    ...
    const editRow = (id) => {
        ...
        // console.log({id});
        $.ajax({
            url: '/LaurelesCalvillo/admin/horarios/ver/'+id,
            method: 'GET',
            beforeSend: () => {
                resetForm();
            },
    ...
    const deleteRow = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/LaurelesCalvillo/admin/horarios/eliminar/"+id,
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                    },
    ...
    const submitDiscount = () => {
        $.ajax({
            url: "<?php echo e(route('admin.update.jacuzzi_discount')); ?>",
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            },
    ...
    const loadSettingsData = () => {
        $.ajax({
            url: "<?php echo e(route('admin.get.settings_discount')); ?>",
            method: 'GET',
            success: (res) => {
                // console.log({res});
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LaurelesCalvillo\resources\views/backend/jacuzzi/schedules/index.blade.php ENDPATH**/ ?>