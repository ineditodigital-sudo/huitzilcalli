                    ...
                    <a class="dropdown-toggle text-dark no-arrow d-flex text-decoration-none" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="d-none d-md-block">
                                ...
                                <span class="d-block small opacity-60 text-decoration-none fs-6"><?php echo e((Auth::user()->user_type == 'admin') ? 'Administrador' : 'Usuario'); ?></span>
                            </span>
                        </span>
                    </a>
                    <ul class="dropdown-menu">
                        <li>
                            <a href="#" class="dropdown-item text-decoration-none" type="button">
...
</div><?php /**PATH /Users/carlosmartinez/Downloads/laureles-web (6)/resources/views/backend/inc/nav.blade.php ENDPATH**/ ?>