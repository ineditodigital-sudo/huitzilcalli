        ...
        <header class="bg-own-secondary text-light py-4">
            <div class="container d-flex justify-content-between flex-wrap">
                ...
                <div class="d-flex x-flex-fill title-icons">
                    ...
                    <a href="https://www.instagram.com/?url=temporal.huitzilcalli.com/jacuzzi/<?php echo e($cabin->slug); ?>" target="_blank" class="d-none btn btn-outline-light btn-icon rounded-circle d-flex align-items-center justify-content-center mx-1">
    ...
    <script>
        ...
        const shareWhatsapp = () => {
            if(
             ...
             || navigator.userAgent.match(/Windows Phone/i)
                ...
                window.open('whatsapp://send?text=https://temporal.huitzilcalli.com/jacuzzi/<?php echo e($cabin->slug); ?>', '_blank');
            }else{
                window.open('https://web.whatsapp.com/send?text=https://temporal.huitzilcalli.com/jacuzzi/<?php echo e($cabin->slug); ?>', '_blank');
            }
        }
        ...
        const shareFacebook = () => {
            if(window.orientation > 1){
                window.open('fb://page/temporal.huitzilcalli.com/jacuzzi/<?php echo e($cabin->slug); ?>', '_blank');
            }else{
                window.open('https://www.facebook.com/sharer/sharer.php?u=temporal.huitzilcalli.com/jacuzzi/<?php echo e($cabin->slug); ?>', '_blank');
            }
        }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laurelescalvillo/public_html/temporal.huitzilcalli.com/resources/views/frontend/services/jacuzzis/detalles.blade.php ENDPATH**/ ?>