        ...
        <header class="bg-own-secondary text-light py-4">
            <div class="container d-flex justify-content-between flex-wrap">
                ...
                <div class="d-flex x-flex-fill title-icons">
                    ...
                    <a href="https://www.instagram.com/?url=huitzilcalli.com/caba%C3%B1a/<?php echo e($cabin->slug); ?>" target="_blank" class="d-none btn btn-outline-light btn-icon rounded-circle d-flex align-items-center justify-content-center mx-1">
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                select: function(info) {
                    ...
                    let url = encodeURI('https://wa.me/5214493102203?text='+('Hola, me gustaría reservar la amenidad <?php echo e($cabin->name); ?> '+textDate));
        ...
        const makeRequest = () => {
            ...
            let url = encodeURI('https://wa.me/5214493102203?text='+('Hola, me gustaría reservar la amenidad <?php echo e($cabin->name); ?> '+((selectedDates != null) ? ('del '+selectedDates.start.split(',')[0]+','+selectedDates.start.split(',')[1]+' al '+selectedDates.end.split(',')[0]+','+selectedDates.end.split(',')[1]) : '')));
        ...
        const shareWhatsapp = () => {
            if(
             ...
             || navigator.userAgent.match(/Windows Phone/i)
                ...
                window.open('whatsapp://send?text=https://huitzilcalli.com/caba%C3%B1a/<?php echo e($cabin->slug); ?>', '_blank');
            }else{
                window.open('https://web.whatsapp.com/send?text=https://huitzilcalli.com/caba%C3%B1a/<?php echo e($cabin->slug); ?>', '_blank');
            }
        }
        ...
        const shareFacebook = () => {
            if(window.orientation > 1){
                window.open('fb://page/huitzilcalli.com/caba%C3%B1a/<?php echo e($cabin->slug); ?>', '_blank');
            }else{
                window.open('https://www.facebook.com/sharer/sharer.php?u=huitzilcalli.com/caba%C3%B1a/<?php echo e($cabin->slug); ?>', '_blank');
            }
        }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/huitzilcalli/public_html/resources/views/frontend/services/amenities/detalles.blade.php ENDPATH**/ ?>