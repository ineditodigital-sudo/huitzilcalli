                        ...
                        <div class="col-md-6 p-5 bg-cristal">
                            <form action="<?php echo e(route('login')); ?>" novalidate method="post" autocomplete="off" class="needs-validation">
                                ...
                                <div class="d-flex w-100 align-items-center justify-content-center img-logo">
                                    <img style=" aspect-ratio: 1/1; max-width: 40%; width: 40%;" class="img-fluid" src="<?php echo e(Vite::asset('resources/img/logo.png')); ?>" alt="Banner">
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/carlosmartinez/Downloads/laureles-web (6)/resources/views/auth/login.blade.php ENDPATH**/ ?>