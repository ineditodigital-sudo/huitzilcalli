...
<div id="calendar-section" class="row d-none">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if(isMobile()){
                ...
                calendar.setOption('eventSources', [
                    'https://localhost/LaurelesCalvillo/admin/res/cabañas/mobileJson/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>',
                ...
                calendar.setOption('eventSources', [
                    'https://localhost/LaurelesCalvillo/admin/res/cabañas/json/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>',
                    'https://localhost/LaurelesCalvillo/admin/dias/json/<?php if(!empty($cabin)): ?><?php echo e($cabin->id); ?><?php else: ?><?php echo e(__('0')); ?><?php endif; ?>'
                ]);
            }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LaurelesCalvillo\resources\views/backend/reservation/index.blade.php ENDPATH**/ ?>