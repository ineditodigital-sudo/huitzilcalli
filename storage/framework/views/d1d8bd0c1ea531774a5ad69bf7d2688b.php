...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-auto">
            <h1 class="h4"><?php echo e(__('Jacuzzis')); ?></h1>
        </div>
...
<div class="row d-none" id="cards-section">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-3">
        <div class="card position-relative">
            <div class="d-flex" style="min-height: 15rem; max-height: 12rem; <?php if($jacuzzi->active == 0): ?> filter: grayscale(1); <?php endif; ?>">
                ...
                <div id="carousel-<?php echo e($jacuzzi->id); ?>" class="carousel slide w-100 flex-fill" data-bs-ride="carousel">
                    <div class="carousel-inner" style="min-height: 15rem; max-height: 12rem;">
                        ...
                        <div class="carousel-item <?php if($g==0): ?> active <?php endif; ?>" style="object-fit: cover; background-image: url('https://localhost/LaurelesCalvillo/public<?php echo e($photo->route); ?>'); background-size: cover; background-repeat:no-repeat; background-position: center; min-height: 15rem; max-height: 12rem;">
                            <!--<img src="" class="d-block w-100 img-fluid" style="object-fit: cover; background-image: url('https://localhost/LaurelesCalvillo/public<?php echo e($photo->route); ?>'); background-size: cover; background-repeat:no-repeat; background-position: center; min-height: 15rem; max-height: 12rem;" alt="">-->
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
            ...
            <div class="dropdown position-absolute top-0 end-0 border-0" style="z-index: 1000">
                ...
                <ul class="dropdown-menu dropdown-menu-dark">
                    ...
                    <li><a href="<?php echo e(route('reservaciones.jacuzzi', ['slug' => $jacuzzi->slug])); ?>" target="_blank" class="dropdown-item">Reservar</a></li>
                            ...
                            <div class="row">
                                <div class="col-sm-7 mb-3">
                                    ...
                                    <div class="input-group has-validation">
                                        ...
                                        <input type="text" id="name" name="nombre" class="form-control" placeholder="<?php echo e(__('Nombre del jacuzzi')); ?>" required>
                                ...
                                <div class="col-sm-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="1" id="capacity" name="capacidad" class="form-control" placeholder="<?php echo e(__('Cupo del jacuzzi')); ?>" required>
                                ...
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <div class="input-group has-validation">
                                        <textarea type="text" id="description" maxlength="500" name="descripción" rows="4" class="form-control" style="resize: none;" placeholder="<?php echo e(__('Descripción del jacuzzi')); ?>" required></textarea>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        const loadData = () => {
            $.ajax({
                url: "<?php echo e(route('jacuzzis.show', ['id' => 0])); ?>",
                method: 'GET',
                success: (res) => {
                    // if(res.table_view){
        ...
        const editRow = (id) => {
            ...
            // console.log({id});
            $.ajax({
                url: '/LaurelesCalvillo/admin/jacuzzis/ver/'+id,
                method: 'GET',
                beforeSend: () => {
                    resetForm();
                },
        ...
        const deleteRow = (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/LaurelesCalvillo/admin/jacuzzis/eliminar/"+id,
                        method: 'DELETE',
                        headers: {
        ...
        const initDropzone = (gallery = []) => {
            ...
            myDropzone = new Dropzone("#drop", {
                url: "/LaurelesCalvillo/admin/upload/" + (id == '' ? 0 : id) ,
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                },
                uploadMultiple: true,
        ...
        const initImageUploader = (gallery = []) => {
            ...
            gallery.forEach(photo => {
                preloaded.push({
                    id: photo.id,
                    src: '/LaurelesCalvillo/public/'+photo.route
                });
            })
        ...
        const submitData = () => {
            ...
            $.ajax({
                url: "<?php echo e(route('jacuzzis.store')); ?>",
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                },
                ...
                success: () => {
                    ...
                    //}else{
                        ...
                        //if($('input[name="images[]"]')[0].files.length > 0){
                            $.ajax({
                                url: "/LaurelesCalvillo/admin/upload/" + (auxId == '' ? 0 : auxId) ,
                                method: 'POST',
                                headers: {
                                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                                },
        ...
        const changeStatus = (id,el) => {
            console.log({id, el});
            $.ajax({
                url: '<?php echo e(route("jacuzzi.status")); ?>',
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                },
        ...
        const initGrid = () => {
            $.ajax({
                url: '<?php echo e(route("jacuzzis.list")); ?>',
                method: 'GET',
                success: (res) => {
                    $("#grid").dxDataGrid({
                        dataSource: res.data,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LaurelesCalvillo\resources\views/backend/jacuzzi/index.blade.php ENDPATH**/ ?>