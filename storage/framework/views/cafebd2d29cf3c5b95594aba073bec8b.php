...
<?php 
    //var_dump($amenity[4]->amenities[0]->title) 
?>
            ...
            <tbody id="table-body">
                ...
                <tr id="row-<?php echo e($amenity->id); ?>">
                    ...
                    <td class="text-end d-flex justify-content-evenly">
                        <a class="btn btn-add btn-icon rounded-circle btn-xs d-flex aligm-items-center justify-content-center btn-cristal"  href="<?php echo e(route('detallesAmenidad', ['slug' => $amenity->slug])); ?>" target="_blank" title="<?php echo e(__('Visualizar')); ?>">
                            <i class="uil uil-eye d-flex align-items-center justify-content-center fs-5"></i>
                        </a>
                        <a class="btn btn-calendar btn-icon rounded-circle btn-xs d-flex aligm-items-center justify-content-center btn-cristal"  href="<?php echo e(route('reservaciones.cabaña', ['service_type' => 'amenidades' ,'slug' => $amenity->slug])); ?>" target="_blank" title="<?php echo e(__('Crear Reservación')); ?>">
        ...
        <div class="card position-relative">
            ...
            <div class="dropdown position-absolute top-0 end-0 border-0" style="z-index: 1000">
                ...
                <ul class="dropdown-menu dropdown-menu-dark">
                    <li><a href="<?php echo e(route('detallesAmenidad', ['slug' => $amenity->slug])); ?>" style="cursor: pointer" class="dropdown-item">Visualizar</a></li>
                    <li><a href="<?php echo e(route('reservaciones.cabaña', ['service_type' => 'amenidades' ,'slug' => $amenity->slug])); ?>" target="_blank" class="dropdown-item">Reservar</a></li>
...
<div class="modal fade" id="new-cabin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="formAmenidad" novalidate method="post" autocomplete="off" class="needs-validation">
                <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        const newCabin = () => {
            $('#new-cabin-title').text('Nueva Amenidad');
            resetForm();
            //initDropzone();
            initImageUploader();
            initMap();
        ...
        const editRow = (id) => {
            $('#new-cabin-title').text('Editar Amenidad');
            // console.log({id});
            $.ajax({
        ...
        const initDropzone = (gallery = []) => {
            ...
            myDropzone = new Dropzone("#drop", {
                url: "/admin/amenidades/upload/" + (id == '' ? 0 : id) ,
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                },
                uploadMultiple: true,
        ...
        const submitData = () => {
            ...
            // document.getElementById('formAmenidad').submit();
            ...
            $.ajax({
                ...
                success: (response) => {
                  let cabinId = response.cabin_id;
                        ...
                        let fd = new FormData($('#formAmenidad')[0]);

                            $.ajax({
                                url: "/admin/amenidades/upload/" + (cabinId == '' ? 0 : cabinId) ,
                                method: 'POST',
                                headers: {
                                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                                },
                ...
                error: (error) => {
                    ...
                    document.querySelectorAll('#formAmenidad .form-control').forEach(el => {
        ...
        const resetForm = () => {
            document.getElementById('formAmenidad').reset();
            $('#formAmenidad .form-control').toArray().forEach((el)=>{$(el).removeClass('is-invalid')});
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/huitzilcalli/public_html/resources/views/backend/amenities/index.blade.php ENDPATH**/ ?>