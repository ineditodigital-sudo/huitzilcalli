    ...
    <div id="home-section" class="container-fluid" style="overflow-y: hidden;">
        <div class="d-flex flex-column contPadre"  style="height: 100dvh">
            <header id="title-section" class="w-100 headerNew d-flex justify-content-center" style="flex-shrink: 0">
                ...
                <div class="row justify-content-evenly align-items-center" style="flex-grow: 1; overflow-y: auto; scrollbar-width: thin;">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 d-flex">
                        <a href="<?php echo e(route('detalles', ['slug' => $cabin->slug])); ?>" class="btn text-decoration-none text-white w-100 d-flex flex-column flex-fill p-0 border-0 overflow-hidden cabin-card my-2" style="background-color: #194421; transition: all 0.15s ease-in-out; border-radius: 2rem;">
                          
                            <?php if(count($cabin->gallery) > 0): ?>
                                <div class="imgCab-container w-100 d-flex" style="border-bottom-left-radius: 2rem; border-bottom-right-radius: 2rem; aspect-ratio: 1/1;">
                                    <div id="carousel-<?php echo e($cabin->id); ?>" class="carousel slide carousel-fade w-100 d-flex" data-bs-ride="carousel">
...
<?php echo $__env->make('frontend.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Maindsoft\Documents\Repos\LaurelesCalvillo\resources\views/frontend/services/cabins/index.blade.php ENDPATH**/ ?>