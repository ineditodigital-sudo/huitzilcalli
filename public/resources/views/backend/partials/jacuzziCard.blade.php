...
<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-3">
    <div class="card position-relative">
        <div class="bg-primary d-flex" style="min-height: 15rem; max-height: 12rem; @if($jacuzzi->active == 0) filter: grayscale(1); @endif">
        ...
        <div class="dropdown position-absolute top-0 end-0 border-0" style="z-index: 1000">
            ...
            <ul class="dropdown-menu dropdown-menu-dark">
                ...
                <li><a href="{{ route('reservaciones.cabaña', ['service_type' => 'jacuzzis' ,'slug' => $jacuzzi->slug]) }}" target="_blank" class="dropdown-item">Reservar</a></li>
