            ...
            <div class="d-flex justify-content-around align-items-center align-items-stretch">
                <div class="aiz-topbar-item">
                    <div class="d-flex align-items-center">
                        <a class="btn btn-icon rounded-circle btn-outline-light d-flex align-items-center justify-content-center" href="{{ route('home')}}" target="_blank" title="{{ __('Sitio Web Principal') }}">
                    ...
                    <a class="dropdown-toggle text-dark no-arrow d-flex text-decoration-none" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="d-none d-md-block">
                                <!-- <span class="d-block fw-bold text-decoration-none">{{Auth::user()->name}}</span> -->
                                <span class="d-block small opacity-60 text-decoration-none text-white fs-6" id="username-nav">{{ (Auth::user()->user_type == 'admin') ? Auth::user()->name : 'Usuario'}}</span>
                            </span>
                        </span>
                    </a>
                    <ul class="dropdown-menu">
                        <li>
                            <a href="{{ route('admin.profile') }}" class="dropdown-item text-decoration-none" type="button">
