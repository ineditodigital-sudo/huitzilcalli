            ...
            <tbody id="table-body">
                ...
                <tr id="row-{{ $amenity->id }}">
                    ...
                    <td class="text-end d-flex justify-content-evenly">
                        ...
                        @endif
                        <a class="btn btn-calendar btn-icon rounded-circle btn-xs d-flex aligm-items-center justify-content-center btn-cristal"  href="{{ route('reservaciones.jacuzzi', ['slug' => $amenity->slug]) }}" target="_blank" title="{{ __('Crear Reservación') }}">
        ...
        <div class="card position-relative">
            ...
            <div class="dropdown position-absolute top-0 end-0 border-0" style="z-index: 1000">
                ...
                <ul class="dropdown-menu dropdown-menu-dark">
                    ...
                    <li><a href="{{ route('reservaciones.jacuzzi', ['slug' => $amenity->slug]) }}" target="_blank" class="dropdown-item">Reservar</a></li>
