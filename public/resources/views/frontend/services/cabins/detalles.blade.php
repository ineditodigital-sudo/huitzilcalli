...
@section('script')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                select: function(info) {
                    ...
                    let url = encodeURI('https://wa.me/5214493102203?text='+('Hola, me gustaría reservar la cabaña {{ $cabin->name }} '+textDate));
        ...
        const makeRequest = () => {
            ...
            let url = encodeURI('https://wa.me/5214493102203?text='+('Hola, me gustaría reservar la cabaña {{ $cabin->name }} '+((selectedDates != null) ? ('del '+selectedDates.start.split(',')[0]+','+selectedDates.start.split(',')[1]+' al '+selectedDates.end.split(',')[0]+','+selectedDates.end.split(',')[1]) : '')));
