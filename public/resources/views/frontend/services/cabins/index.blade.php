            ...
            <header id="title-section" class="w-100 headerNew d-flex justify-content-center" style="flex-shrink: 0">
                ...
                <div class="row justify-content-evenly align-items-center" style="flex-grow: 1; overflow-y: auto; scrollbar-width: thin;">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 d-flex">
                        <a href="{{ route('detalles', ['slug' => $cabin->slug]) }}" class="btn text-decoration-none text-white w-100 d-flex flex-column flex-fill p-0 border-0 overflow-hidden cabin-card my-2" style="transition: all 0.15s ease-in-out; border-radius: 2rem;">
