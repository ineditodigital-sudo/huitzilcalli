        ...
        <header class="bg-own-secondary text-light py-4">
            <div class="container d-flex justify-content-between flex-wrap">
                ...
                <div class="d-flex x-flex-fill title-icons">
                    ...
                    <a href="https://www.instagram.com/?url=www.huitzilcalli.com/caba%C3%B1a/{{ $cabin->slug }}" target="_blank" class="d-none btn btn-outline-light btn-icon rounded-circle d-flex align-items-center justify-content-center mx-1">
                ...
                <div class="col-lg-3 col-md-4 col-sm-12 d-flex">
                    <div class="row flex-fill align-items-between">
                        <div class="col-12 mb-3">
                            <div class="card bg-secondary">
                                <div class="card-body text-center">
                                    <button class="btn btn-outline-primary btn-lg" type="button" data-bs-toggle="modal" data-bs-target="#more-info">
                        ...
                        <div class="col-12 mb-3">
                            <div class="card bg-secondary">
                                <div class="card-body text-center">
                                    <button class="btn btn-outline-primary btn-lg" onClick="makeRequest()">
...
@section('script')
    ...
    <script>
        ...
        const shareWhatsapp = () => {
            // window.open('whatsapp://send?text=www.huitzilcalli.com/caba%C3%B1a/{{ $cabin->slug }}', '_blank');
            ...
            if(
             ...
             || navigator.userAgent.match(/Windows Phone/i)
                ...
                window.open('whatsapp://send?text=https://www.huitzilcalli.com/caba%C3%B1a/{{ $cabin->slug }}', '_blank');
            }else{
                window.open('https://web.whatsapp.com/send?text=https://www.huitzilcalli.com/caba%C3%B1a/{{ $cabin->slug }}', '_blank');
            }
        }
        ...
        const shareFacebook = () => {
            if(window.orientation > 1){
                window.open('fb://page/www.huitzilcalli.com/caba%C3%B1a/{{ $cabin->slug }}', '_blank');
            }else{
                window.open('https://www.facebook.com/sharer/sharer.php?u=www.huitzilcalli.com/caba%C3%B1a/{{ $cabin->slug }}', '_blank');
            }
        }
    </script>
@endsection