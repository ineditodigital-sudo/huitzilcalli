...
use App\Http\Requests\StoreAmenitieRequest;
use App\Http\Requests\UpdateAmenitieRequest;
...
class AmenitieController extends Controller
{
    ...
    {
        $amenities = Cabin::where('service_id',3)->whereNull('deleted_at')->get();
        //
    ...
    public function show(Request $request, $id)
    {
        ...
        if($id != 0){
            ...
            $jacuzzis = Cabin::where('service_id',3)->whereNull('deleted_at')->get();
    ...
    public function upload(Request $request, $id){
        ...
        if(!is_null($images)){
            foreach($images as $key => $image){
                ...
                $size = $image->getSize();
                $route = '/uploads/amenidades/'.$file_name;
                $dimensions = getimagesize($image);
                
                
                $image->move(public_path('uploads/amenidades'),$file_name);
